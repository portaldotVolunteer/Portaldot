...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("portaldot"),
...
parameter_types! {
	...
	pub const BondingDuration: pallet_staking::EraIndex = 60;
	pub const SlashDeferDuration: pallet_staking::EraIndex = 15; // 1/4 the bonding duration.
