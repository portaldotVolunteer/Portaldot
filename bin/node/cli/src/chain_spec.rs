...
use node_runtime::{
	AuthorityDiscoveryConfig, BabeConfig, BalancesConfig, GrandpaConfig,
	ImOnlineConfig, SessionConfig, SessionKeys, StakerStatus,
...
fn portaldot_config_genesis() -> GenesisConfig {
...
/// portaldot config.
pub fn portaldot_config() -> ChainSpec {
	let boot_nodes = vec![];
	ChainSpec::from_genesis(
		"Staging Testnet",
		"staging_testnet",
		ChainType::Live,
		portaldot_config_genesis,
		boot_nodes,
		None,
		None,
		None,
...
pub fn testnet_genesis(
	...
	const ENDOWMENT: Balance = 50_000 * DOLLARS;
	const STASH: Balance = 30_000 * DOLLARS;
